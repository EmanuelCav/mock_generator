...
export const column = [
  { type: 'number', topic: ["Person", "All topics"], name: "Age", data: () => faker.number.int({ min: 18, max: 95 }) },
  { type: 'number', topic: ["Person", "All topics"], name: "Biography", data: () => faker.person.bio() },
  { type: 'string', topic: ["Person", "All topics"], name: "Full name", data: () => faker.person.fullName() },
  { type: 'string', topic: ["Person", "All topics"], name: "First name", data: () => faker.person.firstName() },
  { type: 'string', topic: ["Person", "All topics"], name: "Gender", data: () => faker.person.gender() },
  ...
  { type: 'string', topic: ["Person", "All topics"], name: "Last name", data: () => faker.person.lastName() },
  { type: 'string', topic: ["Person", "All topics"], name: "Middle name", data: () => faker.person.middleName() },
  { type: 'string', topic: ["Person", "All topics"], name: "Prefix", data: () => faker.person.prefix() },
  ...
  { type: 'string', topic: ["Transport", "All topics"], name: "Airlane", data: () => faker.airline.airline() },
  { type: 'string', topic: ["Transport", "All topics"], name: "Airplane", data: () => faker.airline.airplane() },
  { type: 'string', topic: ["Transport", "All topics"], name: "Airport", data: () => faker.airline.airport() },
  ...
  { type: 'string', topic: ["Transport", "All topics"], name: "Seat", data: () => faker.airline.seat() },
  ...
  { type: 'string', topic: ["Computing", "All topics"], name: "Git commit date", data: () => faker.git.commitDate() },
  ...
  { type: 'string', topic: ["Computing", "Person", "All topics"], name: "Username", data: () => faker.internet.userName() },
  ...
  { type: 'string', topic: ["Computing", "Person", "All topics"], name: "Email", data: () => faker.internet.email() },
  ...
  { type: 'string', topic: ["Computing", "Person", "All topics"], name: "Password", data: () => faker.internet.password() },
  ...
  { type: 'string', topic: ["Computing", "All topics"], name: "Common file name", data: () => faker.system.commonFileName() },
  ...
  { type: 'string', topic: ["Computing", "General", "All topics"], name: "Alphabet letters", data: () => faker.string.alpha() },
  { type: 'string', topic: ["Computing", "General", "All topics"], name: "Alpha characters and digits", data: () => faker.string.alphanumeric() },
  { type: 'string', topic: ["Computing", "All topics"], name: "Characters", data: () => faker.string.fromCharacters("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz") },
  { type: 'string', topic: ["Computing", "All topics"], name: "Nano ID", data: () => faker.string.nanoid() },
  { type: 'string', topic: ["Computing", "General", "All topics"], name: "Digits", data: () => faker.string.numeric() },
  { type: 'string', topic: ["Computing", "All topics"], name: "Octal", data: () => faker.string.octal() },
  { type: 'string', topic: ["Computing", "All topics"], name: "UTF-16 chars", data: () => faker.string.sample() },
  { type: 'string', topic: ["Computing", "General", "All topics"], name: "Symbol", data: () => faker.string.symbol() },
  { type: 'string', topic: ["Computing", "All topics"], name: "ULID", data: () => faker.string.ulid() },
  { type: 'string', topic: ["Computing", "All topics"], name: "UUID v4", data: () => faker.string.uuid() },
  { type: 'string', topic: ["Computing", "General", "All topics"], name: "Boolean", data: () => faker.datatype.boolean().toString() },
  { type: 'string', topic: ["Computing", "Number", "All topics"], name: "BigInt number", data: () => faker.number.bigInt().toString() },
  { type: 'string', topic: ["Computing", "Number", "All topics"], name: "Binary number", data: () => faker.number.binary() },
  { type: 'string', topic: ["Computing", "Number", "All topics"], name: "Float number", data: () => faker.number.float().toString() },
  { type: 'string', topic: ["Computing", "Number", "All topics"], name: "Number", data: () => faker.number.int().toString() },
  { type: 'string', topic: ["Computing", "Number", "All topics"], name: "Roman numeral", data: () => faker.number.romanNumeral() },
  { type: 'string', topic: ["Number", "All topics"], name: "IMEI number", data: () => faker.phone.imei() },
  { type: 'string', topic: ["Number", "Person", "All topics"], name: "Phone number", data: () => faker.phone.number() },
  { type: 'string', topic: ["Date", "Person", "All topics"], name: "Birth date", data: () => faker.date.birthdate().toISOString() },
  { type: 'string', topic: ["Date", "General", "All topics"], name: "Any time", data: () => faker.date.between({ from: '2000-01-01', to: '2030-01-01' }).toISOString() },
  { type: 'string', topic: ["Date", "All topics"], name: "Future", data: () => faker.date.future().toISOString() },
  { type: 'string', topic: ["Date", "General", "All topics"], name: "Month", data: () => faker.date.month() },
  { type: 'string', topic: ["Date", "All topics"], name: "Past", data: () => faker.date.past().toISOString() },
  { type: 'string', topic: ["Date", "All topics"], name: "Recent", data: () => faker.date.recent().toISOString() },
  { type: 'string', topic: ["Date", "All topics"], name: "Soon", data: () => faker.date.soon().toISOString() },
